...
namespace gs_patterns
{
    ...
    public:
        ...
        [[nodiscard]] bool get_verbose() const {return _verbose;}
        [[nodiscard]] bool get_use_gs_nv() const {return _use_gs_nv;}
        [[nodiscard]] bool get_one_warp() const {return _one_warp;}
        [[nodiscard]] const std::vector<std::string>& get_positional_args() const {return _positional_args;}
        ...
        [[nodiscard]] size_t get_min_accesses_threshold() const { return _min_accesses_threshold; }
        ...
        void set_min_accesses_threshold(size_t min_accesses_threshold);
    ...
    private:
        ...
        // existing options
        bool _verbose = false;
        bool _use_gs_nv = false;
        bool _one_warp = false;
        ...
        // patterns
        size_t _min_accesses_threshold = 1024; //Threshold for number of accesses
        ...
        // Patterns
        static constexpr size_t MIN_ACCESSES_THRESHOLD = 16; // Minimum number of accesses a pattern must have to be considered.
        static constexpr size_t MAX_ACCESSES_THRESHOLD = 1LL << 14; // Maximum number of accesses (16,384) to require for a pattern.
